...
const Signup = () => {
  ...
  <div className="relative overflow-hidden">
    ...
    <div className="hidden md:block md:absolute md:top-0 md:start-1/2 md:end-0 h-full mw-100% bg-[url('https://img.freepik.com/free-vector/hand-drawn-sustainable-travel-illustration_52683-148456.jpg?w=740&t=st=1711614662~exp=1711615262~hmac=0b9ab13de9abff9d7d22903ee6f8bf2be96fcec8a3cec0f50de671ca23f34f53')] bg-no-repeat bg-center bg-cover ;" />
    {/* End Col */}
  </div>
  {/* End Hero */}
</>
